...
try {
    // Get management staff with their latest medical visit
    $stmt = $pdo->query("
        SELECT 
            w.*,
        ...
        <main class="main-content">
            <div class="section-header">
                <div class="section-header-left">
                    ...
                    <p>View and manage administrative personnel</p>
                </div>
                <div class="header-actions">
                    <a href="<?php echo url('workers/add.php?type=management'); ?>" class="btn-action">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-label">Total Management Staff</div>
                </div>
            ...
            <div class="workers-container">
                ...
                <?php if (empty($workers)): ?>
                    <div class="no-records">
                        ...
                        <p>No management staff records found</p>
                    </div>
                <?php else: ?>
