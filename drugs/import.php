...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv_file'])) {
    ...
    if ($file_ext == 'csv') {
        try {
            ...
            while (($row = fgetcsv($handle)) !== false) {
                ...
                try {
                    ...
                    if ($e->getCode() == 23000) { // Duplicate entry
                        $errors[] = "Drug '{$row[0]}' already exists";
                    } else {
                        $errors[] = "Error adding drug '{$row[0]}': " . $e->getMessage();
                    }
                }
            }
            ...
            if (count($errors) == 0) {
                $pdo->commit();
                $success = "Successfully imported $successCount drugs";
            } else {
                $pdo->rollBack();
        ...
        <main class="main-content">
            <header class="top-bar">
                <div class="welcome-message">
                    <h2>Import Drugs</h2>
                    <p>Upload CSV file with drug records</p>
                </div>
            </header>
                ...
                <div class="import-container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3><i class="fas fa-file-import"></i> Import Drugs</h3>
                        </div>
                        <div class="card-body">
